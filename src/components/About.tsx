    ...
    >
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 8 }}>
          <SectionHeading eyebrow="01 / Background" title="About Me" color="primary" />
          ...
          <Box sx={{ maxWidth: '900px', mx: 'auto' }}>
            ...
            <Box sx={{ mb: 6, overflow: 'hidden' }}>
              ...
              <div className="marquee-container">
                <div className="marquee-content">
                  {[...['Scala', 'Apache Kafka', 'Apache Spark', 'Cloud Technologies', 'Java', 'System Design', 'Rust'], ...['Scala', 'Apache Kafka', 'Apache Spark', 'Cloud Technologies', 'Java', 'System Design', 'Rust']].map((tech, index) => (
                    <Chip
                      key={`${tech}-${index}`}
                      label={tech}
                      size="medium"
            ...
            <Box sx={{ mb: 6, overflow: 'hidden' }}>
              ...
              <div className="marquee-container">
                <div className="marquee-content">
                  {[...['Generative AI', 'Prompt Engineering', 'LLM Integration', 'Containerization', 'Orchestration'], ...['Generative AI', 'Prompt Engineering', 'LLM Integration', 'Containerization', 'Orchestration']].map((skill, index) => (
                    <Chip
                      key={`${skill}-${index}`}
                      label={skill}
                      size="medium"
